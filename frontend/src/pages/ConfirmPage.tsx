...
const ConfirmPage: React.FC = () => {
  ...
  const isInformationRequest = location.state?.isInformationRequest || false
    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          {isInformationRequest ? 'Richiesta Inviata!' : 'Prenotazione Confermata!'}
        </h1>
            ...
            {isInformationRequest ? (
              <>
                <li className="flex items-start">
                  ...
                  Riceverà una email di conferma della richiesta informazioni
                </li>
                <li className="flex items-start">
                  <FileText className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" />
                  La contatteremo al più presto per fornire le informazioni richieste
                </li>
                <li className="flex items-start">
        ...
        >
          {isInformationRequest ? 'Invia un\'altra richiesta' : 'Prenota un altro appuntamento'}
        </Link>
      </div>
    </div>
  )
